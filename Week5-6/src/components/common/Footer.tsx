import greyLogo from "@/assets/svg/ic_logo_grey.svg";

const Footer = () => {
  return (
    <div className="w-full h-[170px] mt-[180px] bg-footerbackground text-footertext text-[11px]">
      <div className="w-1240 max-w-1240 h-full mx-auto px-5 flex pt-[24px] justify-between">
          ...
          <div className="flex flex-col">
            <div className="text-[13px] font-bold flex gap-[28px] mb-[20px]">
              <a
                ...
                target="_blank"
                className="text-footertext hover:underline hover:cursor-pointer hover:text-footertext"
              >
                개인정보처리방침
              </a>
              <a
        ...
        <div
          ...
          className="w-[120px] h-[32px] bg-[#68738C] flex items-center justify-center text-background text-s font-bold hover: cursor-pointer"
        >
          My Site
        </div>
      </div>
